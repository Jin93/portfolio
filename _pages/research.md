...
<div class="row justify-content-sm-center">
    <div class="col-sm-5 mt-3 mt-md-0">
        {% responsive_image path: assets/img/risk_prediction_long.png title: "Example Figure: Disease Risk Prediction" class: "img-fluid rounded z-depth-1" %}
    </div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% responsive_image path: assets/img/T2DAG_long.png title: "T2DAG" class: "img-fluid rounded z-depth-1" %}
    </div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% responsive_image path: assets/img/MRLE_long.png title: "MRLE" class: "img-fluid rounded z-depth-1" %}
    </div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-5 mt-3 mt-md-0">
        {% responsive_image path: assets/img/PCA_long.png title: "PCa detection" class: "img-fluid rounded z-depth-1" %}
    </div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-5 mt-3 mt-md-0">
        {% responsive_image path: assets/img/CBHM_long.png title: "Basket Trials" class: "img-fluid rounded z-depth-1" %}
    </div>
